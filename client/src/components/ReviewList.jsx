              ...
              <div className="flex justify-between items-start gap-4 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link to={`/profile/${review.userId}`} className="flex items-center gap-2 hover:opacity-80 transition-opacity group">
                    <div className="w-6 h-6 rounded-full overflow-hidden border border-yellow-500/30 group-hover:border-yellow-400/50 transition-colors flex-shrink-0">
                      {userData[review.userId]?.profilePicture ? (
                        ...
                        <div className="w-6 h-6 bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center">

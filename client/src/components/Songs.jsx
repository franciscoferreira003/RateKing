  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      {selectedAlbum && (
        ...
        >
          <div
            className="modal-solid max-w-md w-full max-h-[85vh] overflow-y-auto shadow-2xl"
          ...
          >
            ...
            <div className="p-5 flex flex-col items-center text-center">
              ...
              <ListActions
                item={{ id: selectedAlbum.id, title: selectedAlbum.title, year: selectedAlbum.year, poster: selectedAlbum.poster }}
                category="songs"
              />
